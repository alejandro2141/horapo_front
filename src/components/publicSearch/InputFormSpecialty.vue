        ...
        <div class="" >
            <div class="row" style="--bs-gutter-x: 0rem ; margin-right: 0rem ; margin-left: 0rem ">
                ...
                <div class="col" style="position: relative;" >
                    ...
                    <div>
                        <input @keyup="captureSeachLetter" v-model="form_specialty" autocomplete="off" autocorrect="off" spellcheck="false" placeholder  type="text" style=" z-index: 9;  padding-left : 40px ; padding-right : 50px; border-radius: 25px;"  class="form-control form-control-lg border " :class="{'border-success' : ready_input , 'border-primary' : !ready_input , 'text-success' : ready_input }"  id="form_specialty" name="form_specialty"  aria-label=".form-control-lg example"  >
                    </div>
                ...
                <div>
                 vmodel variable={{form_specialty}} 
                </div>
