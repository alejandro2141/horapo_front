...
<template>
        <div @click="checkButton(appType)" :style="{'border-radius': '50%' ,'width': '5.5em', 'height': '5.5em' }"  class="border    p-0 m-2 d-flex justify-content-center align-items-center" :class="{'bg-primary border-4 border-primary': active }" > 
            <div class="m-2">
