...
<template>
<div style="background-color:#2f3e44">
  	
    <div  class="d-flex justify-content-between  mt-0 pt-0 text-white"> 
        ...
        <a HREF="/nested/getAppointments.html" class="text-light  text-decoration-none btn-floating m-2 " >
            Recordar mis Horas  
        </a>
