                ...
                <div class="modal-body mt-0"  > 
                        ...
                        <div class="card-body "  >
                              ...
                              <div class="d-flex justify-content-between  m-1">
                                <div class="fs-5 mt-1"  >
                                    <i class="text-muted bi bi-geo-alt"></i> {{centerToShowDetails.name}} 
                                </div>
                                <div class="">
                                    ...
                                    <div v-if="centerToShowDetails.center_visit" >
                                      ...
                                      -->
                                        ...
                                        <p class="mt-3">
                                            ...
                                            <text class="text-end">{{ comunaId2Name(centerToShowDetails.comuna)  }}, {{centerToShowDetails.address}} </text>
                                        </p>
