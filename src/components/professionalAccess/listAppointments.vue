...
<ModalShowAppointmentTaken v-on:updateAppList="updateAppList"  :daterequired='daterequired'  :hourTaken='hourTaken' :session_params='session_params' :openModalShowAppTakenEvent='openModalShowAppTakenEvent' :global_comunas='global_comunas' :global_specialties='global_specialties'  > </ModalShowAppointmentTaken>
                ...
                <div class="m-2 mt-4">
                    ...
                    <div v-if="hour.app_available != null"  >
                        ...
                        <div v-else >
                            ...
                            <div v-else>    
                                <AppointmentReserved  v-on:displayModalReservedDetails="displayModalReservedDetails" :appointment='hour'  :index="hour.id" :days_expired="days_expired"  :global_specialties='global_specialties' :global_comunas='global_comunas' :specialty_data="appointments_data.specialties.find(elem => elem.id ==  hour.specialty  )" :center_data="appointments_data.centers.find(elem => elem.id ==  hour.center_id  )" :calendar_data="appointments_data.calendars.find(elem => elem.id ==  hour.calendar_id  )"  :session_params='session_params' > </AppointmentReserved>
                            </div>
    ...
    <div v-if="isLockDay">
        <p  class="text-center text-secondary">
            <text style="font-size:6em;"><i  class="text-muted bi bi-lock-fill "></i></text>
        </p>
        <p class="text-center" >
