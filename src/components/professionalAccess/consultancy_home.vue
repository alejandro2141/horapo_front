...
<template>
    <div>
                                        ...
                                        <div class="mt-2 d-flex justify-content-between" >
                                            <text >Comunas Atencion : </text><br>
                                            <text class="text-end"> {{ comunaId2Name(centerDetails.home_comuna1)  }} </text>
                                            <text class="text-end"> {{ comunaId2Name(centerDetails.home_comuna2)  }} </text>
                                        </div>
