                ...
                <tbody class="">
                    ...
                    <tr v-if="week2!=null" class="text-dark" >
                        <td  v-for="day in week2" :key="day" colspan="2" class="" @click="dayPicked(day.date)"> 
                            <div class="h1 fw-lighter" :class="[{ 'text-danger' : tday.getDate() == day.date.getDate()  && tday.getMonth() == day.date.getMonth() , 'text-primary text-decoration-underline fw-normal' : calendar_date.getDate() == day.date.getDate()  && calendar_date.getMonth() == day.date.getMonth()      }]" > 
                                <div class="m-0 p-0 d-flex justify-content-center"> 
